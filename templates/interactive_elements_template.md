...
<div class="tool-comparison-chart">
    ...
    <div class="filter-controls">
        <div class="search-box">
            <input type="text" id="toolSearch" placeholder="🔍 Search..." onkeyup="filterTools()">
        </div>
        <div class="filter-buttons">
            <button class="filter-btn active" onclick="filterByCategory('all')">All</button>
            <button class="filter-btn" onclick="filterByCategory('category1')">Category 1</button>
            <button class="filter-btn" onclick="filterByCategory('category2')">Category 2</button>
        </div>
